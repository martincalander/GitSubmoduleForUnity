...
namespace MartinCalander.GitPackageManager.Editor.Tests
{
    ...
    public sealed class CoordinatorStabilityTests
    {
        ...
        public void WelcomeCanEnterGitOnlyUiAsSoonAsCurrentGitStageIsReady(
            bool isInitialLoading,
            bool isGitStageReady,
            bool isGitAvailable,
            bool expected)
        ...
        public void ToolbarGitActions_AllowOnlyTheOptionalGitHubReaderAfterGitReadiness(
            bool gitAvailable,
            bool isInitialLoading,
            bool isGitStageReady,
        ...
        public void CliInstaller_IsNotOfferedWhileItsServiceWouldRejectKnownState(
        ...
        [Test]
        public void ValidPackageFilter_OnlyShowsConfirmedValidManifests()
        {
            var repo = Repo("package");
